package net.madicorp.smartinvestplus.web.websocket;

import net.madicorp.smartinvestplus.security.SecurityUtils;
import net.madicorp.smartinvestplus.web.websocket.dto.ActivityDTO;
...
import static net.madicorp.smartinvestplus.config.WebsocketConfiguration.IP_ADDRESS;
